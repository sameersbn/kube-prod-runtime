                                ...
                                withGo() {
                                    withCredentials([
                                        ...
                                        withEnv([
                                            ...
                                            sh "make dist VERSION=${GITHUB_TAG_NAME} RELEASES_BASE_URL=https://sameer-bkpr-releases.s3-us-west-1.amazonaws.com"
                                            sh "make publish VERSION=${GITHUB_TAG_NAME} AWS_DEFAULT_REGION=us-west-1 AWS_S3_BUCKET=sameer-bkpr-releases"
                                        }
                                    }
                                }
